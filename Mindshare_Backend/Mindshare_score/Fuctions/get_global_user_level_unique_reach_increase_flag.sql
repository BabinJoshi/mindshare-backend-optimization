-- DROP FUNCTION mindshare_score.get_global_user_level_unique_reach_increase_flag(int8, int8);

CREATE OR REPLACE FUNCTION mindshare_score.get_global_user_level_unique_reach_increase_flag(startdate bigint, enddate bigint)
...
WITH user_post_growth AS (
    select
		*
	from mindshare_score.get_global_unique_reach_increase($1, $2)
),

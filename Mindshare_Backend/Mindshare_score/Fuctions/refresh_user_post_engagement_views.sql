...
BEGIN
    ...
    REFRESH MATERIALIZED VIEW CONCURRENTLY analytics.mv_user_posts_engagement;

    RAISE NOTICE 'Refreshing global user post features view...';
    REFRESH MATERIALIZED VIEW CONCURRENTLY mindshare_score.mv_user_posts_engagement_features;

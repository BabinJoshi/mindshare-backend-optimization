-- mindshare.nucleus_user definition

-- Drop table

-- DROP TABLE mindshare.nucleus_user;
...
CREATE INDEX ix_mindshare_nucleus_user_x_username ON mindshare.nucleus_user USING btree (x_username);